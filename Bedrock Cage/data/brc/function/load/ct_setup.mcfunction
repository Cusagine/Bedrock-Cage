...
setblock -16 -17 -16 minecraft:structure_block[mode=save]{author:"Bedrock Cage",ignoreEntities:0b,integrity:1.0f,metadata:"",mirror:"NONE",mode:"SAVE",name:"brc:",posX:0,posY:1,posZ:0,powered:0b,rotation:"NONE",seed:0L,showair:0b,showboundingbox:1b,sizeX:32,sizeY:48,sizeZ:32}
setblock 0 -17 0 minecraft:structure_block[mode=save]{author:"Bedrock Cage",ignoreEntities:0b,integrity:1.0f,metadata:"",mirror:"NONE",mode:"SAVE",name:"brc:",posX:0,posY:1,posZ:0,powered:0b,rotation:"NONE",seed:0L,showair:0b,showboundingbox:1b,sizeX:16,sizeY:48,sizeZ:16}
