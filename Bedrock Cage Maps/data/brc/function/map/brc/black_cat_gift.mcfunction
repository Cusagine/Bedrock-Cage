...
data modify storage brc:map_info id set value "black_cat_gift"
# title:地图标题。会在载入地图时用作标题。
data modify storage brc:map_info title set value "黑猫的礼物"
# summary:地图摘要。会在载入地图时用作副标题。
data modify storage brc:map_info summary set value "请收下。"
# desc:地图描述。
data modify storage brc:map_info desc set value "在月圆之夜，黑猫会为主人带来礼物。至于是什么礼物，那就要看它找到了什么。"
# content:要加载的模板的命名空间ID。
data modify storage brc:map_info content set value "brc:black_cat_gift"
