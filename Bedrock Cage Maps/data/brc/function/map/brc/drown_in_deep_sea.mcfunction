...
data modify storage brc:map_info id set value "drown_in_deep_sea"
# title:地图标题。会在载入地图时用作标题。
data modify storage brc:map_info title set value "溺于深海"
# summary:地图摘要。会在载入地图时用作副标题。
data modify storage brc:map_info summary set value "醉死在冰冷的海水里。"
# desc:地图描述。
data modify storage brc:map_info desc set value "她给予了黑暗中的人海水般的温暖，却又擅自抛弃了这些人。为什么会有人相信深海是温暖的？"
# content:要加载的模板的命名空间ID。
data modify storage brc:map_info content set value "brc:drown_in_deep_sea"
