...
data modify storage brc:map_info id set value "none_of_mine"
# title:地图标题。会在载入地图时用作标题。
data modify storage brc:map_info title set value "与我无关"
# summary:地图摘要。会在载入地图时用作副标题。
data modify storage brc:map_info summary set value "这是你的问题。"
# desc:地图描述。
data modify storage brc:map_info desc set value "只要照做，这些问题就解决了。你说并不是这样？与我无关，这是你的问题。"
# content:要加载的模板的命名空间ID。
data modify storage brc:map_info content set value "brc:none_of_mine"
